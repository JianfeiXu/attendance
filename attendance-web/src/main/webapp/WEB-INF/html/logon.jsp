...
<html>
	...
	<body class="easyui-layout">
			  			...
			  			<c:forEach items="${topMenu.childrenMenus }" var="secondMenu">
			  				<c:choose>
			  					...
			  					<c:when test="${null != secondMenu.leaf && secondMenu.leaf}">
								      ...
								      <div class="panel-title panel-with-icon " menuUrl="<%=request.getContextPath() %>/${secondMenu.menuUrl }">
								      	${secondMenu.menuName }
								      </div>
		...
		<div id="south_footer" data-options="region:'south',split:false" style="height:50px;"> ©2016  腾飞  版权所有</div>
	</body>
</html>